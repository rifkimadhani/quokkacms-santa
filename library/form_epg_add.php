<?php
function form_epg_tambah($start,$end, $program, $sinopsis,$id,$channelId, $date,$link){
	echo '<div class="col-md-4">';
			echo '<div class="panel panel-primary" style="position: fixed;bottom : 30px;" >
					...
					<form class="form-horizontal" method="POST" action="'.$link.'&show=formtambah&id='.$channelId.'&date='.$date.'">
