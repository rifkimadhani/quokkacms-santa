...
<html>
    <head>
        ...
        <link rel="stylesheet" href="js/jPlayer-2.7.1/skin/blue.monday/jplayer.blue.monday.css" />
        <link rel="stylesheet" href="js/tui.image-editor-3.7.1/tui-image-editor.css">
        <link type="text/css" href="js/tui.color-picker-2.2.0/tui-color-picker.min.css" rel="stylesheet">
        ...
        <script type="text/javascript" src="js/fabric-1.6.7.js"></script>
        <script type="text/javascript" src="js/tui.code-snippet-1.5.0/tui-code-snippet.min.js"></script>
        <script type="text/javascript" src="js/FileSaver.js-1.3.3/FileSaver.min.js"></script>
        <script type="text/javascript" src="js/tui.color-picker-2.2.0/tui-color-picker.min.js"></script>
        <script type="text/javascript" src="js/tui.image-editor-3.7.1/tui-image-editor.js"></script>
