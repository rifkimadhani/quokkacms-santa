...
use App\Models\LiveTvCategoryModel;
use App\Models\LiveTvCategoryForm;

class LiveTvCategory extends BaseController
{
    public function index()
    {
        $baseUrl = $this->getBaseUrl();

        $mainview = 'livetv_category/index';
        $pageTitle = 'LiveTvCategory';

        $model = new LiveTvCategoryModel();
        $fieldList = $model->getFieldList();

        $form = new LiveTvCategoryForm();
     ...
     */
    public function edit($livetvCategoryId)
    {
        $model = new LiveTvCategoryModel();
        $data = $model->get($livetvCategoryId);
    ...
    public function delete($livetvCategoryId){
        $model = new LiveTvCategoryModel();
        $r = $model->remove($livetvCategoryId);
