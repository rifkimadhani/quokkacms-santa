...
class Kitchen extends BaseController
{
    public function index()
    {
        ...
        $mainview = 'kitchen/index';
        $pageTitle = 'Kitchen';

        $model = new KitchenModel();
        $fieldList = $model->getFieldList();

        $form = new KitchenForm();
     ...
     */
    public function edit($kitchenId)
    {
        $model = new KitchenModel();
        $data = $model->get($kitchenId);
    ...
    public function delete($kitchenId){
        $model = new KitchenModel();
        $r = $model->remove($kitchenId);
