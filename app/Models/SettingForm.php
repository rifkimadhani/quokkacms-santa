...
//    public $value_float;
    ...
    function __construct()
    {
        ...
        $this->value_int = ['type'=>'numeric', 'label'=>'Value Int', 'placeholder'=>'', 'required'=>''];
        $this->value_string = ['type'=>'varchar', 'label'=>'Value String', 'placeholder'=>'', 'required'=>''];
//        $this->value_float = ['type'=>'varchar', 'label'=>'Value Float', 'placeholder'=>'', 'required'=>''];
