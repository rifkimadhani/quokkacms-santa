...
//$htmlNew = $form->renderDialog('New hotelservice', 'formNew', "{$baseUrl}/insert");
$htmlDelete = Dialog::renderDelete('Delete hotelservice', 'CONFIRM DELETE');
?>
...
<script>
                ...
                columnDefs: [
                    {
                        ...
                        targets: [0,1,3,7,11],visible: false,searchable: false
                    },
                    {
                        // action column
                        targets: lastCol,
    ...
    function onClickTrash(event, that) {
        ...
        showDialogDelete('formDelete', 'Are you sure to delete ' + name, function () {
            window.location.href = "<?=$baseUrl?>/delete/" + taskId;
        })
    }
